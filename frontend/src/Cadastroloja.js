...
import {
  ...
  CheckboxLink,
  BotaoCadastrar
} from "./components/cadastrolojaestrutura";
    ...
    <BackgroundImage>
      <Formulario>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label htmlFor="nomeLoja"><b>Nome da Loja</b></label>
          <Input type="text" placeholder="Digite o nome da loja" name="nomeLoja" required value={formData.nomeLoja} onChange={handleChange} />

          <label htmlFor="cnpj"><b>CNPJ</b></label>
          <Input type="text" placeholder="Digite o CNPJ" name="cnpj" required value={formData.cnpj} onChange={handleChange} />
